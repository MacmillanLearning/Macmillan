 ...
 */
package org.macmillan.test.setup;
...
import org.macmillan.test.constants.MacmillanTestConstants;
import org.macmillan.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MacmillanTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/macmillantest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/macmillantest/import/reviews.impex");
				...
				importImpexFile(context, "/macmillantest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/macmillantest/import/csquotes.impex");
			}
		}
	}
}
