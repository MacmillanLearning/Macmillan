 ...
 */
package org.macmillan.core.suggestion;
...
import org.macmillan.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/macmillancore/test/testSimpleSuggestionService.csv", "utf-8");
	}
